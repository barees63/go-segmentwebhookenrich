...
var (
	...
	// filter carefully so as not to recommend any page without desired content.
	//
	// Topic Filter:
	// -------------------------------------------
	...
	// active hour of day for the user. If no data exists, the email will send immediately
